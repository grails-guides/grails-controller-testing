...
*_Before continuing please delete src/test/groovy/demo/StudentServiceSpec.groovy_*

[source, groovy]
.grails-app/services/demo/StudentService.groovy
----
include::{sourceDir}/grails-app/services/demo/StudentService.groovy[indent=0]
----
...
----
include::{sourceDir}/grails-app/controllers/demo/StudentController.groovy[tags=injectedStudentService]
include::{sourceDir}/grails-app/controllers/demo/StudentController.groovy[tags=calculateAvgGradeMethod]
----
