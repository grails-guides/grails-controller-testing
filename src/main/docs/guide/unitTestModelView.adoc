...
----
include::{sourceDir}/grails-app/controllers/demo/StudentController.groovy[tags=indexMethod]
----
...
----
include::{sourceDir}/src/test/groovy/demo/StudentControllerSpec.groovy[tag=specBeginning]
